...
contract BruTusToKen is Pausable, StandardTokenWithFees, BlackList {
    ...
    function BruTusToKen(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
